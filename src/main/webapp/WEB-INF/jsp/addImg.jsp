...
<div class="container">
    <div class="row">
        <div class="span8 offset2">
            ...
            <h3>分頁圖片連結設定</h3>
            <hr size="8px" align="center" width="100%">
            <form:form method="post" action="updatePageUrl" commandName="pageUrlForm" class="form-vertical">

                <form:label path="about">關於</form:label><br>
                <form:input path="about" value="${pageUrlForm.about}" style="width: 100%; height:30px;"/><br>
                <br>
                <form:label path="service">產品服務</form:label><br>
                <form:input path="service" value="${pageUrlForm.service}" style="width: 100%; height:30px;"/><br>
                <br>
                <form:label path="contact">聯絡我們</form:label><br>
                <form:input path="contact" value="${pageUrlForm.contact}" style="width: 100%; height:30px;"/><br>
                <br>
