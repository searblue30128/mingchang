...
<!--         <li class="nav-item active"> -->
        ...
        <li class="nav-item">
          <a class="nav-link" href="<%=request.getContextPath()%>/home/about">About</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<%=request.getContextPath()%>/home/service">Services</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<%=request.getContextPath()%>/home/contact">Contact</a>
        </li>
      </ul>
    </div>
  </div>
